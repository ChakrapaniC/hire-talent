      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-2xl md:text-5xl font-bold text-gray-800 mb-4">
            Expert <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-clip-text text-transparent">Oracle Consultants</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {oracleCategories.map((category, index) => (
            <div
              key={category.id}
              className={`${category.bgColor} rounded-3xl p-6 border-2 transition-all duration-700 border-blue-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
              ...
              <div className="mb-4">
                <div className="flex flex-wrap gap-1">
                  {category.services.slice(0, 3).map((service, serviceIndex) => (
                    <span
                      key={serviceIndex}
                      className="px-2 py-1 text-white text-xs font-medium rounded-full bg-gradient-to-r from-blue-500 to-cyan-500"
                    >
                      {service}
                    </span>
                  ))}
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
              Our <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Implementation Process</span>
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl mb-4 text-white">
                  {step.icon}
                </div>
